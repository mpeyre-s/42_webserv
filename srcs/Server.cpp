...
Server::Server() {
	...
	root_location.root = "website/";
	root_location.index = "website/index.html";
	root_location.alias = false;
	root_location.client_body_buffer_size = 1 * 1024 * 1024; // 1MB
	...
	images_location.root = "website/images";
	...
	api_location.root = "website/api";
	api_location.index = "api.php";
	api_location.alias = true;
